...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/flota/ubicaciones', fn() => view('admin.flota-ubicaciones'));
    Route::get('/flota/ubicaciones/{idCamion}', fn($idCamion) => view('admin.flota-mapa-detalle', ['idCamion' => $idCamion]));

                        ...
                        <div @click="seleccionar(p.id)" 
                            ...
                            <div class="flex items-center justify-between gap-2 mb-2.5">
                                <div class="flex items-center gap-2">
                                    <span class="w-7 h-7 rounded-xl bg-slate-900 text-white font-black text-xs flex items-center justify-center shadow-2xs"
                                ...
                                <span class="px-2.5 py-1 rounded-full text-[11px] font-black uppercase tracking-wide border shadow-2xs" 
                                      :class="{
                            ...
                            <div class="flex items-center justify-between p-2.5 rounded-xl bg-slate-50 border border-slate-100 mb-3 text-xs">
                                <div>

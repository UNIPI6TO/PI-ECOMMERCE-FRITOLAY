                        ...
                        <div @click="seleccionar(p.id)" 
                            ...
                            <div class="flex items-center justify-between gap-2 mb-1.5">
                                ...
                                <span class="px-2.5 py-1 rounded-full text-[11px] font-black uppercase tracking-wide border shadow-2xs shrink-0" 
                                      :class="{
                                          'bg-amber-100 text-amber-800 border-amber-200': p.estado === 'listo_para_entregar' || p.estado === 'en_espera_asignacion',
                                      ...
                                      x-text="p.estado === 'en_ruta' ? 'EN RUTA' : (p.estado === 'listo_para_entregar' ? 'LISTO PARA ENTREGAR' : (p.estado === 'no_entregado' ? 'DEVUELTO' : String(p.estado || '').replace(/_/g, ' ').toUpperCase()))"></span>
                            </div>

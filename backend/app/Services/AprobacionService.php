...
class AprobacionService
{
    ...
    {
        return \Illuminate\Support\Facades\DB::transaction(function () use ($pedidoId, $operadorId) {
    ...
    {
        return \Illuminate\Support\Facades\DB::transaction(function () use ($pedidoId, $operadorId, $motivo) {
            $pedido = $this->pedidoRepository->findById($pedidoId);
